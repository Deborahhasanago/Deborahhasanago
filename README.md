...
## Chosen Development Model: AGILE MODEL
...
appointments, view health records, and contact with clinic staff.
...
appointment adherence and greater patient-clinician contact.
  2. Story: Clinical Assessment Entry (Clinician)
User Type: Clinician
...
3. Story: Appointment Management for Clinicians
...
patients reminders about their forthcoming appointments.4. Offer a User-Friendly Interface for Staff: Employees can handle appointments, and
...
security.
4. Administrative Dashboard: (admin/clinician)
...
- **Architecture:**
![architecture 1](https://github.com/Deborahhasanago/Deborahhasanago/assets/156446628/57cdda59-aea2-42ea-9ba2-5226170e34e0)
![architecture 2](https://github.com/Deborahhasanago/Deborahhasanago/assets/156446628/493842db-4ed4-4397-8598-7dadce64488a)

- **Database:**
![image](https://github.com/Deborahhasanago/Deborahhasanago/assets/156446628/6f81bfe1-a8ec-4d32-a943-92127d9de624)
![image (1)](https://github.com/Deborahhasanago/Deborahhasanago/assets/156446628/cda00294-6ab3-4390-80b2-648b171a81e9)

- **Technologies Used:**
1. Database: XAMPP | MySQL are the programs I used to manage the database and connect it with
the website.
2. Compiler: VS Code
3. FrontEnd: HTML/CSS/JAVASCRIPT are the languages used for the layout, styling, and
interactive nature of the page.
4. BackEnd: PHP is the language used for server management and database connection.
...
![login12](https://github.com/Deborahhasanago/Deborahhasanago/assets/156446628/69a34850-b4e5-47a4-bf91-a4b2032aa11b)
